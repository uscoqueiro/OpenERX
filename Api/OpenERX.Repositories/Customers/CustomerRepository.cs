...
namespace OpenERX.Repositories.Customers
{
    ...
    {
        private readonly CustomerImageRepository imageRepository;
        private readonly SqlConnectionProvider connectionProvider;

        public CustomerRepository(
            CustomerImageRepository imageRepository,
        ...
        public async Task<Customer> InsertAsync(Customer customer)
        {
            ...
            await this.imageRepository.InsertByCustomerAsync(customer.Id, customer.Images);
        ...
        public async Task<long> UpdateAsync(Customer customer)
        {
            ...
            await this.imageRepository.DeleteByCustomerAsync(customer.Id);
            await this.imageRepository.InsertByCustomerAsync(customer.Id, customer.Images);
        ...
        public async Task<long> DeleteAsync(Guid id)
        {
            ...
            await this.imageRepository.DeleteByCustomerAsync(id);
        ...
        public async Task<Customer> GetAsync(Guid id)
        {
            ...
            {
                var result = GetDataRecord(dataReader);
                result.Images = await this.imageRepository.GetByCustomerAsync(id);
